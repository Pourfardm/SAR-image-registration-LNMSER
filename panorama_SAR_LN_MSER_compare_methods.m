...
% buildingDir = fullfile('D:\mohammad file\Database Images\All challenging images\test13');
...
imwrite(readimage(buildingScene, 2),[buildingDir,'\test_imhist\2.tif']);
GG=readimage(buildingScene, 1);
GG1 = imhistmatch(GG,readimage(buildingScene, 2));
imwrite(GG1,[buildingDir,'\test_imhist\1.tif']);
%     imshow(GG);title(['Theta= ',num2str(theta)]);
% imshow(GG1);title('Imhisteq');
...
gradThresh=[0.1,0.3,0.5,0.7,0.9,1];
iteration_number=5;
tic
